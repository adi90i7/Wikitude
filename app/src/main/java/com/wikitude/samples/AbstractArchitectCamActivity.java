		...
		if (hasGeo()) {
			...
			this.locationListener = new LocationListener() {
				...
				public void onLocationChanged( final Location location ) {
					...
					if (location!=null) {
						location.setAltitude(getIntent().getExtras().getDouble("srcLongitude"));
						location.setLatitude(getIntent().getExtras().getDouble("srcLongitude"));
						location.setLongitude(getIntent().getExtras().getDouble("srcLongitude"));
						location.setAccuracy(getIntent().getExtras().getFloat("srcLongitude"));
